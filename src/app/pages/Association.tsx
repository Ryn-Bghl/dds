import { GraduationCap, Wrench, Radio, Users, Target, Heart } from "lucide-react";
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl mb-8 text-center text-foreground">Notre Histoire</h2>
            <div className="prose prose-lg mx-auto text-muted-foreground">
              <p className="text-lg leading-relaxed mb-4">
                Fondée en 2016, <strong className="text-foreground">Dons Du Son</strong> est née de la rencontre entre des professionnels du secteur audio 
                et des passionnés de musique, tous animés par la volonté de démocratiser l'accès aux moyens de production musicale.
              </p>
              <p className="text-lg leading-relaxed mb-4">
                Face au constat que de nombreux artistes émergents manquent de moyens techniques et financiers pour concrétiser 
                leurs projets, nous avons décidé de créer une structure associative permettant de mutualiser les ressources 
                et les compétences.
              </p>
              <p className="text-lg leading-relaxed mb-4">
                Aujourd'hui, nous sommes une équipe de 15 bénévoles actifs et comptons plus de 200 adhérents. 
                Notre association est reconnue d'intérêt général et œuvre quotidiennement pour le développement 
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl mb-12 text-center text-foreground">Nos Valeurs</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {values.map((value, index) => (
              <Card key={index} className="text-center hover:shadow-lg hover:shadow-[#8C0343]/20 transition-all border-border bg-card">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl mb-4 text-center text-foreground">Nos Axes d'Intervention</h2>
          ...
          <div className="space-y-12 max-w-6xl mx-auto">
            {interventionAreas.map((area, index) => (
              <Card key={index} className="overflow-hidden hover:shadow-xl hover:shadow-[#8C0343]/10 transition-all border-border bg-card">
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
                    ...
                    <div className="lg:col-span-2 p-8">
                      <h4 className="text-xl mb-4 text-foreground">Actions concrètes :</h4>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl mb-4 text-center text-foreground">Notre Équipe</h2>
          <p className="text-xl text-muted-foreground text-center mb-12">
            Les membres du bureau qui portent l'association au quotidien
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {team.map((member, index) => (
              <Card key={index} className="overflow-hidden hover:shadow-lg hover:shadow-[#8C0343]/20 transition-all border-border bg-background">
                <CardContent className="p-0">
