      ...
      <section className="py-12 bg-background border-b border-border">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Gallery / Image */}
            <div className="rounded-3xl overflow-hidden border border-border bg-card aspect-square relative group">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <Editable path={`${basePath}.category`} label="Catégorie">
                  <Badge variant="outline" className="text-[#F29F05] border-[#F29F05]/30">
                    {item.category}
                  </Badge>
                </Editable>
              ...
              <Editable path={`${basePath}.name`} label="Nom du matériel">
                <h1 className="text-4xl md:text-6xl font-bold text-white">{item.name}</h1>
              </Editable>

              <Editable path={`${basePath}.price`} label="Prix journalier">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-[#F29F05]">{item.price}€</span>
              ...
              <div className="pt-6 flex flex-wrap gap-4">
                <Button size="lg" className="bg-[#8C0343] hover:bg-[#771236] text-white px-8 h-14 text-lg font-bold">
              ...
              {/* Specs */}
              <div className="pt-8">
                <h3 className="text-sm uppercase tracking-widest text-muted-foreground font-bold mb-4">Caractéristiques techniques</h3>
