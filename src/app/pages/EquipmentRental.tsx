...
const equipmentCatalog: Equipment[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1678356434281-0ef01a3ac02d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZWNvcmRpbmclMjBzdHVkaW8lMjBtaWNyb3Bob25lfGVufDF8fHx8MTc3NDU5ODA2NXww&ixlib=rb-4.1.0&q=80&w=1080",
    price: 15,
  ...
  },
  {
    ...
    price: 40,
    description:
      "Générateur de fumée pour mise en valeur des faisceaux lumineux",
  ...
  // DJ
  {
    ...
    image:
      "https://images.unsplash.com/photo-1774118042703-4f3c3ebfa0eb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaiUyMHR1cm50YWJsZXMlMjBlcXVpcG1lbnR8ZW58MXx8fHwxNzc0NjIwMTcwfDA&ixlib=rb-4.1.0&q=80&w=1080",
    price: 55,
  ...
  // Backline
  {
    ...
    image:
      "https://images.unsplash.com/photo-1565719178004-420e3480e2b5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtdXNpYyUyMGluc3RydW1lbnRzJTIwYmFja2xpbmV8ZW58MXx8fHwxNzc0NjIwMTcyfDA&ixlib=rb-4.1.0&q=80&w=1080",
    price: 65,
...
export default function EquipmentRental() {
  ...
  const handleSubmitQuote = (e: React.FormEvent) => {
    ...
    toast.success(
      "Demande de devis envoyée ! Nous vous recontacterons sous 24h.",
    );
    setCart([]);
    setQuoteForm({
      name: "",
