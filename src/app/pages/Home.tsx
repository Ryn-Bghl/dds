...
import { ArrowRight, Music, Users, Lightbulb, Calendar, Wrench, Radio } from "lucide-react";
    ...
    <div className="flex flex-col">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1700166269606-b5ea327d0540?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzb3VuZCUyMG1peGluZyUyMGNvbnNvbGUlMjBzdHVkaW98ZW58MXx8fHwxNzc0NTMyNTE2fDA&ixlib=rb-4.1.0&q=80&w=1080')",
          }}
        >
        ...
        <div className="relative container mx-auto px-4 text-center text-white z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-[#F29F05] text-black hover:bg-[#D96704]">
              <Link to="/association">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="prose prose-lg mx-auto text-gray-300">
              <p className="text-xl leading-relaxed">
                <strong className="text-[#F29F05]">Dons Du Son</strong> est née d'une conviction : la culture doit être accessible à tous. 
                Depuis 2016, nous œuvrons pour démocratiser l'accès aux équipements techniques professionnels 
                et accompagner les artistes émergents dans leurs projets musicaux.
              </p>
              <p className="text-xl leading-relaxed mt-4">
                Notre mission : <em className="text-[#F29F05]">former, équiper et connecter</em> les talents de demain, 
                tout en créant des ponts entre les acteurs culturels du territoire.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {services.map((service, index) => (
              <Card key={index} className="bg-[#1a1a1a] border-gray-800 hover:border-[#8C0343] hover:shadow-lg transition-all">
            ...
            {latestProjects.map((project) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent flex flex-col justify-end p-6">
                  <span className="text-[#F29F05] text-sm mb-2">{project.category}</span>
      ...
      <section className="py-20 bg-gradient-to-br from-[#771236] to-[#0D0D0D] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            Devenez bénévole, adhérent ou soutenez nos actions pour contribuer au développement de la scène musicale locale
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-[#F29F05] text-black hover:bg-[#D96704]">
              <Link to="/rejoindre">
